//
//  Edit_VoiceAndLanguageViewController.m
...
#import "Edit_VoiceAndLanguageViewController.h"

@interface Edit_VoiceAndLanguageViewController ()

@end

@implementation Edit_VoiceAndLanguageViewController
...
- (void)viewDidLoad
{
    moduleName = [moduleTitles objectAtIndex:4];
