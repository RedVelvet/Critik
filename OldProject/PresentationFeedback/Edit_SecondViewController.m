...
#import "Edit_SecondViewController.h"

@interface Edit_SecondViewController ()

@end

@implementation Edit_SecondViewController
...
- (void)viewDidLoad
{
    moduleName = [moduleTitles objectAtIndex:1];
